...
class PracticesController < ApplicationController
  ...
  def like
    ...
    @like = Like.new(account_id: current_account.id, practice_id: @practice.id)

    if @like.save
      subject = "[Agroecology Map] Someone liked your agroecological practice. "
      body = "Liked by: #{@like.account.name} (" + account_url(@like.account) + ")"
      body += "\r\n \r\n"
      body += "Link to your practice: " + location_practice_url(@practice.location, @practice)
      body += "\r\n \r\n"
