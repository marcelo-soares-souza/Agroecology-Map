!(function (e, t) {
                  ...
                  e.map((e) =>
                      (function (e) {
                          return new Promise((t, o) => {
                              ...
                              i.addEventListener("load", t.bind(e), { once: !0 }), (i.src = e), document.head.appendChild(i);
                          });
                      })(e)
                  )
              );
    ...
    function n(e, t) {
        let [o, i] = (function (e) {
                let t = L.latLngBounds(
                        [e.getElementsByTagName("south")[0].childNodes[0].nodeValue, e.getElementsByTagName("west")[0].childNodes[0].nodeValue],
                        [e.getElementsByTagName("north")[0].childNodes[0].nodeValue, e.getElementsByTagName("east")[0].childNodes[0].nodeValue]
                    ),
        ...
        return (
            ...
            (n = t.icons[n] || n),
            r && ((r = r.childNodes[0].nodeValue), (s.opacity = parseInt(r.substring(0, 2), 16) / 255), (s.color = "#" + r.substring(6, 8) + r.substring(4, 6) + r.substring(2, 4))),
            i && (s.rotation = i),
    ...
    const a = (L.KMZLayer = L.FeatureGroup.extend({
        options: { interactive: !0, ballon: !0, bindPopup: !0, bindTooltip: !0, preferCanvas: !1 },
        ...
        load: function (e) {
            L.KMZLayer._jsPromise = i(this._requiredJSModules(), L.KMZLayer._jsPromise)
                .then(() => {
                    return (
                        (t = e),
                        new Promise((e, o) => {
                            ...
                            i.open("GET", t),
                                ...
                                (i.onload = () => {
                                    4 !== i.readyState || (200 !== i.status && 0 !== i.status) ? e("") : e(i.response || i.responseText);
                                }),
                                (i.onerror = () => o("Error " + i.status + " while fetching remote file: " + t)),
                                i.send();
                        })
                    );
                    var t;
                ...
                .then((t) => {
                    return this.parse(t, { name: ((o = e), o.split("/").pop()), icons: {} });
                    var o;
                });
        },
        parse: function (e, t) {
                ...
                window.JSZip.loadAsync(n).then((t) => {
                    var i = Object.keys(t.files).map((e) => {
                        ...
                        if (o(e)) {
                            ...
                            return i.async("base64").then((t) => [e, "data:" + r + ";base64," + t]);
                        }
                        return i.async("text").then((t) => [e, t]);
                    });
                    Promise.all(i).then((t) => e(t.reduce((e, t) => ((e[t[0]] = t[1]), e), {})));
                });
            })).then((e) => {
                var n = t(e),
                    r = Object.keys(e).filter((e) => o(e)),
                    a = e[n];
                (i.icons = r.reduce((t, o) => ((t[o] = e[o]), t), {})), this._parseKML(a, i);
            });
        },
        _parseKML: function (e, t) {
            var o = r(e),
                ...
                n = (this.options.geometryToLayer || this._geometryToLayer).call(this, i, o);
            this.addLayer(n), this.fire("load", { layer: n, name: i.properties.name });
        },
        _geometryToLayer: function (e, t) {
            var o = this._map ? this._map.options.preferCanvas : this.options.preferCanvas,
                ...
                r = L.geoJson(e, {
                    pointToLayer: (t, n) =>
                        o
                            ? L.kmzMarker(n, { iconUrl: e.properties.icons[t.properties.icon] || t.properties.icon || i, iconSize: [28, 28], iconAnchor: [14, 14], interactive: this.options.interactive })
                            : L.marker(n, { icon: L.icon({ iconUrl: e.properties.icons[t.properties.icon] || t.properties.icon || i, iconSize: [28, 28], iconAnchor: [14, 14] }), interactive: this.options.interactive }),
                    style: (e) => {
                        var t = {},
                            o = e.properties;
                        return (
                    ...
                    onEachFeature: (e, t) => {
                        if (this.options.ballon) {
                            var o = e.properties,
                                i = o.name || "",
                                n = o.description || "";
                            (i || n) && (this.options.bindPopup && t.bindPopup("<div><b>" + i + "</b><br>" + n + "</div>"), this.options.bindTooltip && t.bindTooltip("<b>" + i + "</b>", { direction: "auto", sticky: !0 }));
                        }
                    },
                    interactive: this.options.interactive,
                });
            let a = t.getElementsByTagName("GroundOverlay");
            for (let t, o = 0; o < a.length; o++) (t = n(a[o], e.properties)), t && r.addLayer(t);
            return r;
        },
        _requiredJSModules: function () {
            var e = [],
                t = "";
            return "function" != typeof window.JSZip && e.push(t + "/jszip.min.js"), "object" != typeof window.toGeoJSON && e.push(t + "/togeojson.umd.js"), e;
        },
    }));
        ...
        (L.KMZMarker = L.CircleMarker.extend({
            _updatePath: function () {
                ...
                e._drawing &&
                    ...
                    (t
                        ? t.drawImage()
                        : (((t = this._icon = new Image(this.options.iconSize[0], this.options.iconSize[1])).anchor = [t.width / 2, t.height / 2]),
