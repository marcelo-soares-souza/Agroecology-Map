...
usuario_agroecologia = Usuario.new(nome: "Agroecologia", email: "contact@mapadaagroecologia.org", password: "agroecologia", password_confirmation: "agroecologia", admin: "f")
