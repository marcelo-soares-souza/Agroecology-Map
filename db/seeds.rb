...
usuario_admin = Usuario.new(nome: "Admin", email: "admin@agroecologymap.org", password: "agroecology",
                            password_confirmation: "agrecology", admin: "t")
usuario_admin.skip_confirmation!
usuario_admin.save!

usuario_agroecologia = Usuario.new(nome: "Agroecology Map", email: "contact@agroecologymap.org",
                                   password: "agroecology", password_confirmation: "agroecology", admin: "f")
