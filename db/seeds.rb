...
usuario_admin = Usuario.new(nome: "Administrador", email: "admin@agroecologia", password: "agroecologia",
                            password_confirmation: "agroecologia", admin: "t")
usuario_admin.skip_confirmation!
usuario_admin.save!

usuario_agroecologia = Usuario.new(nome: "Agroecologia", email: "contact@mapadaagroecologia.org",
                                   password: "agroecologia", password_confirmation: "agroecologia", admin: "f")
